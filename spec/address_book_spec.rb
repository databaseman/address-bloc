 ...
 RSpec.describe AddressBook do
   ...
   describe "#remove_entry" do
    it "remove only one entry from the address book" do
      book = AddressBook.new
      book.add_entry('First user', '010.012.1815', 'augusta.king@lovelace.com')
      book.add_entry('Second user', '010.012.1815', 'augusta.king@lovelace.com')
      expect(book.entries.size).to eq(2)
      book.remove_entry('First user', '010.012.1815', 'augusta.king@lovelace.com')
      expect(book.entries.size).to eq(1)
      old_entry=book.entries[0]
      expect(old_entry.name).to eq('Second user')
    end
   end
